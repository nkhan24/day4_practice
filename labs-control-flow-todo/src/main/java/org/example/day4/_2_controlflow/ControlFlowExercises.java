...
public class ControlFlowExercises {
    ...
    boolean kidsRide(int temp, boolean isWinter) {
        if (isWinter == true && temp > 10 && temp <= 30) {

            return true;

        } else if (isWinter == false && temp > 15 && temp <= 30) {
            return true;
        } else return false;
    ...
    boolean find8(int a, int b) {
        if (a == 8 || b == 8 || Math.abs(a + b) == 8 || Math.abs(a - b) == 8 || a * b == 8) {
            return true;
        } else return false;
    }
    ...
    boolean goOut(boolean isSunday, boolean isMom, boolean isPast20) {
        ...
        if (isPast20 == true || isMom == false && isSunday == true) {
            return false;
        } else return true;
    ...
    boolean hangPaintings(int small, int big, int length) {
        if (small * 1 == length || big * 5 == length || (small * 1) + (big * 5) == length) {
            return true;
        } else return false;
    }
